...
this.libcutils = (function() {
  let lib;
  try {
    // TODO vmx2017-05-25: We can't use ctypes directly anymore. Replace
    // it with some HTTP/WebSockets API with a server exposing the properties.
    // I'll leave the code here so that whoever implements has a reference.
    // See
    // https://stackoverflow.com/questions/28413530/api-to-get-android-system-properties-is-removed-in-arm64-platforms/32820960#32820960
    // for more details.
