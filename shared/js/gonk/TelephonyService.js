...
// NOTE vmx 2017-05-25: Those two are already defined in RadioInterfaceLayer
// I keep them as at one point there might be a proper module system and
...
MMI_PROC_TO_CF_ACTION[MMI_PROCEDURE_ACTIVATION] = nsIMobileConnection.CALL_FORWARD_ACTION_ENABLE;
MMI_PROC_TO_CF_ACTION[MMI_PROCEDURE_DEACTIVATION] = nsIMobileConnection.CALL_FORWARD_ACTION_DISABLE;
MMI_PROC_TO_CF_ACTION[MMI_PROCEDURE_INTERROGATION] = nsIMobileConnection.CALL_FORWARD_ACTION_QUERY_STATUS;
MMI_PROC_TO_CF_ACTION[MMI_PROCEDURE_REGISTRATION] = nsIMobileConnection.CALL_FORWARD_ACTION_REGISTRATION;
MMI_PROC_TO_CF_ACTION[MMI_PROCEDURE_ERASURE] = nsIMobileConnection.CALL_FORWARD_ACTION_ERASURE;

const MMI_SC_TO_CF_REASON = {};
MMI_SC_TO_CF_REASON[MMI_SC_CFU] = nsIMobileConnection.CALL_FORWARD_REASON_UNCONDITIONAL;
MMI_SC_TO_CF_REASON[MMI_SC_CF_BUSY] = nsIMobileConnection.CALL_FORWARD_REASON_MOBILE_BUSY;
MMI_SC_TO_CF_REASON[MMI_SC_CF_NO_REPLY] = nsIMobileConnection.CALL_FORWARD_REASON_NO_REPLY;
MMI_SC_TO_CF_REASON[MMI_SC_CF_NOT_REACHABLE] = nsIMobileConnection.CALL_FORWARD_REASON_NOT_REACHABLE;
MMI_SC_TO_CF_REASON[MMI_SC_CF_ALL] = nsIMobileConnection.CALL_FORWARD_REASON_ALL_CALL_FORWARDING;
MMI_SC_TO_CF_REASON[MMI_SC_CF_ALL_CONDITIONAL] = nsIMobileConnection.CALL_FORWARD_REASON_ALL_CONDITIONAL_CALL_FORWARDING;

const MMI_SC_TO_LOCK_TYPE = {};
MMI_SC_TO_LOCK_TYPE[MMI_SC_PIN] = nsIIcc.CARD_LOCK_TYPE_PIN;
MMI_SC_TO_LOCK_TYPE[MMI_SC_PIN2] = nsIIcc.CARD_LOCK_TYPE_PIN2;
MMI_SC_TO_LOCK_TYPE[MMI_SC_PUK] = nsIIcc.CARD_LOCK_TYPE_PUK;
MMI_SC_TO_LOCK_TYPE[MMI_SC_PUK2] = nsIIcc.CARD_LOCK_TYPE_PUK2;

const MMI_PROC_TO_CLIR_ACTION = {};
MMI_PROC_TO_CLIR_ACTION[MMI_PROCEDURE_ACTIVATION] = nsIMobileConnection.CLIR_INVOCATION;
MMI_PROC_TO_CLIR_ACTION[MMI_PROCEDURE_DEACTIVATION] = nsIMobileConnection.CLIR_SUPPRESSION;

const MMI_SC_TO_CB_PROGRAM = {};
MMI_SC_TO_CB_PROGRAM[MMI_SC_BAOC] = nsIMobileConnection.CALL_BARRING_PROGRAM_ALL_OUTGOING;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BAOIC] = nsIMobileConnection.CALL_BARRING_PROGRAM_OUTGOING_INTERNATIONAL;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BAOICxH] = nsIMobileConnection.CALL_BARRING_PROGRAM_OUTGOING_INTERNATIONAL_EXCEPT_HOME;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BAIC] = nsIMobileConnection.CALL_BARRING_PROGRAM_ALL_INCOMING;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BAICr] = nsIMobileConnection.CALL_BARRING_PROGRAM_INCOMING_ROAMING;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BA_ALL] = nsIMobileConnection.CALL_BARRING_PROGRAM_ALL_SERVICE;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BA_MO] = nsIMobileConnection.CALL_BARRING_PROGRAM_OUTGOING_SERVICE;
MMI_SC_TO_CB_PROGRAM[MMI_SC_BA_MT] = nsIMobileConnection.CALL_BARRING_PROGRAM_INCOMING_SERVICE;

const CF_ACTION_TO_STATUS_MESSAGE = {};
CF_ACTION_TO_STATUS_MESSAGE[nsIMobileConnection.CALL_FORWARD_ACTION_ENABLE] = MMI_SM_KS_SERVICE_ENABLED;
CF_ACTION_TO_STATUS_MESSAGE[nsIMobileConnection.CALL_FORWARD_ACTION_DISABLE] = MMI_SM_KS_SERVICE_DISABLED;
CF_ACTION_TO_STATUS_MESSAGE[nsIMobileConnection.CALL_FORWARD_ACTION_REGISTRATION] = MMI_SM_KS_SERVICE_REGISTERED;
CF_ACTION_TO_STATUS_MESSAGE[nsIMobileConnection.CALL_FORWARD_ACTION_ERASURE] = MMI_SM_KS_SERVICE_ERASED;

const LOCK_TYPE_TO_STATUS_MESSAGE = {};
LOCK_TYPE_TO_STATUS_MESSAGE[nsIIcc.CARD_LOCK_TYPE_PIN] = MMI_SM_KS_PIN_CHANGED;
LOCK_TYPE_TO_STATUS_MESSAGE[nsIIcc.CARD_LOCK_TYPE_PIN2] = MMI_SM_KS_PIN2_CHANGED;
LOCK_TYPE_TO_STATUS_MESSAGE[nsIIcc.CARD_LOCK_TYPE_PUK] = MMI_SM_KS_PIN_UNBLOCKED;
LOCK_TYPE_TO_STATUS_MESSAGE[nsIIcc.CARD_LOCK_TYPE_PUK2] = MMI_SM_KS_PIN2_UNBLOCKED;

const CLIR_ACTION_TO_STATUS_MESSAGE = {};
CLIR_ACTION_TO_STATUS_MESSAGE[nsIMobileConnection.CLIR_INVOCATION] = MMI_SM_KS_SERVICE_ENABLED;
CLIR_ACTION_TO_STATUS_MESSAGE[nsIMobileConnection.CLIR_SUPPRESSION] = MMI_SM_KS_SERVICE_DISABLED;

const MMI_KS_SERVICE_CLASS_MAPPING = {};
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_VOICE] = MMI_KS_SERVICE_CLASS_VOICE;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_DATA] = MMI_KS_SERVICE_CLASS_DATA;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_FAX] = MMI_KS_SERVICE_CLASS_FAX;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_SMS] = MMI_KS_SERVICE_CLASS_SMS;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_DATA_SYNC] = MMI_KS_SERVICE_CLASS_DATA_SYNC;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_DATA_ASYNC] = MMI_KS_SERVICE_CLASS_DATA_ASYNC;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_PACKET] = MMI_KS_SERVICE_CLASS_PACKET;
MMI_KS_SERVICE_CLASS_MAPPING[nsIMobileConnection.ICC_SERVICE_CLASS_PAD] = MMI_KS_SERVICE_CLASS_PAD;
...
//XXX vmx 2017-05-22: GO ON HERE and implement those interfaces below
...
// TODO vmx 2017-05-26: Implement `Service` properly. For now, just return 0.
...
//    return id;
  ...
  _procedureToCLIRMode: function(aProcedure) {
    ...
    switch (aProcedure) {
      case MMI_PROCEDURE_ACTIVATION:
        return nsIMobileConnection.CLIR_SUPPRESSION;
      case MMI_PROCEDURE_DEACTIVATION:
        return nsIMobileConnection.CLIR_INVOCATION;
      default:
        return nsIMobileConnection.CLIR_DEFAULT;
    }
  },
  ...
  _getClientIdForEmergencyCall: function() {
    ...
    for (let cid = 0; cid < this._numClients; ++cid) {
      ...
      let cardState = icc ? icc.cardState : nsIIcc.CARD_STATE_UNKONWN;
      if (cardState !== nsIIcc.CARD_STATE_UNDETECTED &&
          cardState !== nsIIcc.CARD_STATE_UNKNOWN) {
        return cid;
      }
    }
  ...
  dial: function(aClientId, aNumber, aIsDialEmergency, aCallback) {
    ...
    if (!aIsDialEmergency) {
      aNumber = PhoneNumberNormalizer.Normalize(aNumber)
    }

    // Validate the number.
    // Note: isPlainPhoneNumber also accepts USSD and SS numbers
    if (!PhoneNumber.IsPlain(aNumber)) {
...
// TODO vmx 2017-06-05: Implement this check
...
//    }
  ...
  _dialCall: function(aClientId, aNumber, aClirMode = RIL.CLIR_DEFAULT,
    ...
    if (!isEmergency) {
// TODO vmx 2017-06-05: Implement these checks
//      if (!this._isRadioOn(aClientId)) {
...
//      }
  ...
  _callForwardingMMI: function(aClientId, aMmi, aCallback) {
    ...
    if (action === nsIMobileConnection.CALL_FORWARD_ACTION_QUERY_STATUS) {
      ...
      case MMI_PROCEDURE_INTERROGATION:
        connection.getCallWaiting({
          notifyGetCallWaitingSuccess: function(aServiceClass) {
            if (aServiceClass === nsIMobileConnection.ICC_SERVICE_CLASS_NONE) {
              aCallback.notifyDialMMISuccess(MMI_SM_KS_SERVICE_DISABLED);
              return;
            }
  ...
  _siToServiceClass: function(aSi) {
    if (!aSi) {
      return nsIMobileConnection.ICC_SERVICE_CLASS_NONE;
    }

    let serviceCode = parseInt(aSi, 10);
    switch (serviceCode) {
      case 10:
        return nsIMobileConnection.ICC_SERVICE_CLASS_SMS +
               nsIMobileConnection.ICC_SERVICE_CLASS_FAX +
               nsIMobileConnection.ICC_SERVICE_CLASS_VOICE;
      case 11:
        return nsIMobileConnection.ICC_SERVICE_CLASS_VOICE;
      case 12:
        return nsIMobileConnection.ICC_SERVICE_CLASS_SMS +
               nsIMobileConnection.ICC_SERVICE_CLASS_FAX;
      case 13:
        return nsIMobileConnection.ICC_SERVICE_CLASS_FAX;
      case 16:
        return nsIMobileConnection.ICC_SERVICE_CLASS_SMS;
      case 19:
        return nsIMobileConnection.ICC_SERVICE_CLASS_FAX +
               nsIMobileConnection.ICC_SERVICE_CLASS_VOICE;
      case 21:
        return nsIMobileConnection.ICC_SERVICE_CLASS_PAD +
               nsIMobileConnection.ICC_SERVICE_CLASS_DATA_ASYNC;
      case 22:
        return nsIMobileConnection.ICC_SERVICE_CLASS_PACKET +
               nsIMobileConnection.ICC_SERVICE_CLASS_DATA_SYNC;
      case 25:
        return nsIMobileConnection.ICC_SERVICE_CLASS_DATA_ASYNC;
      case 26:
        return nsIMobileConnection.ICC_SERVICE_CLASS_DATA_SYNC +
               nsIMobileConnection.ICC_SERVICE_CLASS_VOICE;
      case 99:
        return nsIMobileConnection.ICC_SERVICE_CLASS_PACKET;
      default:
  ...
  _serviceClassToStringArray: function(aServiceClass) {
    let services = [];
    for (let mask = nsIMobileConnection.ICC_SERVICE_CLASS_VOICE;
         mask <= nsIMobileConnection.ICC_SERVICE_CLASS_MAX;
         mask <<= 1) {
